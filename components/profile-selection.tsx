  ...
  return (
    ...
    >
      {profiles.map((profile, index) => (
        ...
        >
          <div className="image-container rounded-md overflow-hidden border-2 border-transparent hover:border-[color:var(--nf-text)] transition-all duration-300 w-[150px] h-[150px]">
            <ResponsiveImage
              src={profile.image}
              alt={profile.alt}
              width={150}
          ...
          <h3 className="profile-name text-gray-400 mt-3 text-center capitalize hover:text-nf-text transition-colors duration-300">
            {profile.name}
          </h3>
        </motion.div>
      ))}
