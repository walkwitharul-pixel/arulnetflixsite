                  ...
                  >
                    ...
                    <div className="flex gap-2">
                      <Link
                        ...
                        className="nf-btn inline-flex items-center justify-center gap-1.5 h-8 px-3 rounded-[4px] bg-white text-black text-sm font-bold hover:bg-white/75 transition-colors"
                      >
                        <FaPlay className="text-[10px]" /> Details
                      </Link>
                      {project.liveUrl && (
                        <a
                          ...
                          className="nf-btn inline-flex items-center justify-center gap-1.5 h-8 px-3 rounded-[4px] bg-[#6d6d6eb3] text-white text-sm font-bold hover:bg-[#6d6d6e66] transition-colors"
                        >
