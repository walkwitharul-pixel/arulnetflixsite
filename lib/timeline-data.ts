export const timelineData = [
  {
    ...
    summaryPoints:
      "Leading VELANTEC — Singapore parent company combining strategy, design, communication, and technology. Portfolio home for MrAssistant.Ai, GrowthLab, ONESTOPSG, Aval/Avan, and more. 100+ projects delivered across the ecosystem.",
  },
  {
    timelineType: "work",
    title: "Founder and CEO",
  ...
  },
  {
    ...
    summaryPoints:
      "Leading ONESTOPSG — full-service marketing & social agency (brand, demand, web, content). Google Partner, Meta Business Partner, TikTok & HubSpot certified. Serving Singapore & SEA since 2016.",
  },
  {
    timelineType: "work",
    title: "Founder",
    ...
    techStack: "Community Platform, AI Matching, Mentorship, Funding Tools, Events",
    summaryPoints:
      "Building GrowthLab — global startup ecosystem / LinkedIn for startups. 2,500+ members, 1,200+ startups, funding tools, mentorship, AI matching, and events with partners like *SCAPE, SGInnovate, and Claude AI.",
  },
  {
    timelineType: "work",
    title: "Founder",
    ...
    techStack: "Voice AI, LLMs, No-code Automations, SIP Telephony",
    summaryPoints:
      "Building MrAssistant.Ai — no-code AI voice agents for phone automation. 40+ languages, 250+ integrations, white-label plans, and numbers across 150+ countries.",
  },
  {
    timelineType: "work",
